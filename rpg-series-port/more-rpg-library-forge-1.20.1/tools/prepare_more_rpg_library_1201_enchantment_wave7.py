...
contracts = {
    'RegistryKeys.ENCHANTMENT': forge_after.count('RegistryKeys.ENCHANTMENT'),
    'MoreRpg1201Enchantments.register()': forge_after.count('MoreRpg1201Enchantments.register()'),
    'MoreRpg1201Enchantments.attachSchoolSources()': common_after.count('MoreRpg1201Enchantments.attachSchoolSources()'),
    'MRPGCMod.id("typhoon")': compat_after.count('MRPGCMod.id("typhoon")'),
    'MRPGCMod.id("stonebloom")': compat_after.count('MRPGCMod.id("stonebloom")'),
    'Set.of(MoreSpellSchools.AIR, MoreSpellSchools.WATER)': compat_after.count('Set.of(MoreSpellSchools.AIR, MoreSpellSchools.WATER)'),
    'Set.of(MoreSpellSchools.EARTH, MoreSpellSchools.NATURE)': compat_after.count('Set.of(MoreSpellSchools.EARTH, MoreSpellSchools.NATURE)'),
    'new EnchantmentsConfig.PowerEnchantmentConfig(true, 5, 1, 11, 12, 11, 0.03F)': compat_after.count('new EnchantmentsConfig.PowerEnchantmentConfig(true, 5, 1, 11, 12, 11, 0.03F)'),
    'SpellPowerMod.armorEnchantmentLevel': compat_after.count('SpellPowerMod.armorEnchantmentLevel'),
    'isAcceptableItem(ItemStack stack)': compat_after.count('isAcceptableItem(ItemStack stack)'),
}
for needle, actual in contracts.items():
    expected = 2 if needle == 'new EnchantmentsConfig.PowerEnchantmentConfig(true, 5, 1, 11, 12, 11, 0.03F)' else 1
    if actual != expected:
