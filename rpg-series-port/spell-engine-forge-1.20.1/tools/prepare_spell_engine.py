...
# Current feature authority is Spell Engine 1.10.4 on the 1.21.1 line. The certified Forge 1.20.1
# TinyConfig port preserves the modern net.tiny_config package and versioning API, including
# VersionableConfig, so do NOT downgrade imports to legacy net.tinyconfig or erase versioning.
# The graduation runner reconstructs the certified TinyConfig 3.1.0 common/Forge JARs before
# this generated project is compiled and launched.

# Optional integrations are isolated only during the core compatibility gate. Their exact 1.20.1
# implementations are restored before the final parity/package gate.
stubs={
'net/spell_engine/compat/MeleeCompat.java': '''package net.spell_engine.compat;\nimport net.minecraft.entity.Entity;\nimport net.minecraft.entity.player.PlayerEntity;\nimport java.util.function.Function;\npublic class MeleeCompat {\n public record Attack(boolean isCombo, boolean isOffhand) { public static final Attack EMPTY=new Attack(false,false); }\n public static Function<PlayerEntity,Attack> attackProperties=p->Attack.EMPTY;\n public static Function<Entity,Boolean> isEntityHostileVehicle=e->false;\n public static void init() {}\n}\n''',
