...
# TinyConfig 3.x changed package/versioning APIs after 1.20.1. Keep the proven 1.20.1 library while
# retaining the 1.10.2 config surfaces; further semantic adapters are applied as compiler evidence demands.
