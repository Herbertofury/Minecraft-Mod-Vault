...
# Uplift only the historical 1.10.2 authority/path/artifact labels in this CI workspace.
# All actual compatibility, TinyConfig 3.1, deterministic build, client, packaged-server,
# first-green and frozen-replay gates remain owned by the audited graduation harness.
python3 - "$BASE" <<'PY'
...
bash -n "$BASE"
echo '[Spell Engine 1.10.4] TARGET_AUTHORITY_UPLIFT_PASS sha=8843cea8974afffc7ec42c096cac33327a3af3d8'
exec bash "$GRAD"
