...
summon minecraft:husk 0 100 3 {Tags:["palqa_judgement_target"],NoAI:1b,Silent:1b,PersistenceRequired:1b}
...
execute positioned 0 100 0 if entity @a[distance=..0.25] run say PALADINS_JUDGEMENT_STUN_MOVE_BLOCK_PASS
...
execute positioned 0 100 0 unless entity @a[distance=..0.50] run say PALADINS_JUDGEMENT_CONTROL_MOVE_PASS
