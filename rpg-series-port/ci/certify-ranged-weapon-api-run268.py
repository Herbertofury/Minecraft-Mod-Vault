...
CERT_SHA256 = "96c81b8187eea072fca39e809c1a339679ec5a2adf5b6ba93ccb8dbbf32ec6ae"
CERT_NORMALIZED_MANIFEST_SHA256 = "7c6d8378e2a3da0395b89a9ac0c91b21987a02d91ceb59bfc4b29fc3b8f72d3c"
CERT_ENTRY_COUNT = 95
...
def validate_release_contract(zf: zipfile.ZipFile) -> None:
    ...
    required = {
        ...
        "META-INF/jars/mixinextras-forge-0.4.1.jar",
    }
...
def main() -> None:
    ...
    if token == CERT_TOKEN:
        ...
        print(f"[Ranged Weapon API certification] already exact canonical bytes: {CERT_SHA256}")
        return
    ...
    print(
        f"[Ranged Weapon API certification] canonicalized generated namespace {token.decode()} -> {CERT_TOKEN.decode()} "
        f"(PlatformMethods deflate delta {delta:+d})"
    )
    print(f"[Ranged Weapon API certification] exact canonical authority bytes proven: {CERT_SHA256}")
