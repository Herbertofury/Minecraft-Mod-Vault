...
public final class ModelPredicateHelper {
    public static void registerBowModelPredicates(CustomBow bow) {
        ...
        ModelPredicateProviderRegistryInvoker.rwa_invokeRegister(bow, new Identifier("pulling"), (stack, world, entity, seed) -> entity != null && entity.isUsingItem() && entity.getActiveItem() == stack ? 1F : 0F);
    }
    public static void registerCrossbowModelPredicates(CustomCrossbow crossbow) {
        for (var id : new Identifier[]{new Identifier("pull"),new Identifier("pulling"),new Identifier("charged"),new Identifier("firework")}) {
            ...
            if (provider != null) {
                ModelPredicateProviderRegistryInvoker.rwa_invokeRegister(crossbow, id, (stack, world, entity, seed) -> provider.call(stack, world, entity, seed));
            }
        }
    }
