...
public class SpellSchools {
    ...
    public static SpellSchool createMagic(Identifier id,int color,boolean customDamageType,EntityAttribute attr,StatusEffect effect){
        var school=new SpellSchool(SpellSchool.Archetype.MAGIC,id,color,customDamageType?RegistryKey.of(RegistryKeys.DAMAGE_TYPE,id):DamageTypes.MAGIC,attr,effect);
    ...
    public static SpellSchool configureAsMagic(SpellSchool school,EntityAttribute powerAttribute){
        school.addSource(SpellSchool.Trait.POWER,new SpellSchool.Source(SpellSchool.Apply.ADD,q->q.entity().getAttributeValue(powerAttribute)));
    ...
    public static SpellSchool configureSpellHaste(SpellSchool school){
        school.addSource(SpellSchool.Trait.HASTE,new SpellSchool.Source(SpellSchool.Apply.ADD,q->q.entity().getAttributeValue(SpellPowerMechanics.HASTE.attribute)/PERCENT_ATTRIBUTE_BASELINE-1));
        school.addSource(SpellSchool.Trait.HASTE,new SpellSchool.Source(SpellSchool.Apply.ADD,q->{ var e=Enchantments_SpellPowerMechanics.HASTE; return e.amplified(0,SpellPowerEnchanting.getEnchantmentLevelEquipmentSum(e,q.entity())); }));
        return school;
    }
    public static SpellSchool configureSpellCritChance(SpellSchool school){
        school.addSource(SpellSchool.Trait.CRIT_CHANCE,new SpellSchool.Source(SpellSchool.Apply.ADD,q->q.entity().getAttributeValue(SpellPowerMechanics.CRITICAL_CHANCE.attribute)/PERCENT_ATTRIBUTE_BASELINE-1));
        school.addSource(SpellSchool.Trait.CRIT_CHANCE,new SpellSchool.Source(SpellSchool.Apply.ADD,q->{ var e=Enchantments_SpellPowerMechanics.CRITICAL_CHANCE; return e.amplified(0,SpellPowerEnchanting.getEnchantmentLevelEquipmentSum(e,q.entity())); }));
        return school;
    }
    public static SpellSchool configureSpellCritDamage(SpellSchool school){
        school.addSource(SpellSchool.Trait.CRIT_DAMAGE,new SpellSchool.Source(SpellSchool.Apply.ADD,q->q.entity().getAttributeValue(SpellPowerMechanics.CRITICAL_DAMAGE.attribute)/PERCENT_ATTRIBUTE_BASELINE-1));
        school.addSource(SpellSchool.Trait.CRIT_DAMAGE,new SpellSchool.Source(SpellSchool.Apply.ADD,q->{ var e=Enchantments_SpellPowerMechanics.CRITICAL_DAMAGE; return e.amplified(0,SpellPowerEnchanting.getEnchantmentLevelEquipmentSum(e,q.entity())); }));
        return school;
    }
    @Nullable public static SpellSchool getSchool(String value){ var id=new Identifier(value.toLowerCase(Locale.US)); if(id.getNamespace().equals(Identifier.DEFAULT_NAMESPACE)) id=new Identifier(DEFAULT_NAMESPACE,id.getPath()); return REGISTRY.get(id); }
}
