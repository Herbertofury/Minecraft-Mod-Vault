...
# Architectury Plugin normally creates a random UUID-backed projectID under each subproject's
# .gradle/architectury-cache directory. That UUID is embedded in the transformed injection
# package and changes an otherwise-identical release JAR hash between clean CI workspaces.
# Preseed stable IDs derived from this immutable port identity so clean rebuilds are byte-stable.
architectury_ids = {
    'common': '0674af327c11f602eea7defcf5d514dc',
    'forge': 'baae45cdf3cd30ac01447a62ccd0232e',
}
