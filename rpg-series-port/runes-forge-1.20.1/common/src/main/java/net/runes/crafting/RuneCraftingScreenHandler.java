...
public class RuneCraftingScreenHandler extends ForgingScreenHandler {
    ...
    public static void bootstrap(){ if(HANDLER_TYPE==null) HANDLER_TYPE=new ScreenHandlerType<>(RuneCraftingScreenHandler::new,FeatureFlags.VANILLA_FEATURES); }
    ...
    public RuneCraftingScreenHandler(int syncId,PlayerInventory inventory,ScreenHandlerContext context){
        super(HANDLER_TYPE,syncId,inventory,context); this.world=inventory.player.getWorld();
