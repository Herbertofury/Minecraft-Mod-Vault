...
bash "$ROOT/prepare_sources.sh" "$CURRENT" "$LEGACY" "$OUT"; python3 "$ROOT/apply_1201_forge_registration.py" "$OUT/common/java"; python3 "$ROOT/apply_1201_compat.py" "$OUT/common/java"; python3 "$ROOT/apply_1201_compat_batch2.py" "$OUT/common/java"; python3 "$ROOT/apply_1201_compat_batch3.py" "$OUT/common/java"; python3 "$ROOT/apply_1201_compat_batch4.py" "$OUT/common/java"
