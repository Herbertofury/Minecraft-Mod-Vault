...
- `gradle.properties` blob: `ccc8b423aa4f8a8526d79d27a2fd862da12dd8cc`
...
- `gradle.properties` blob: `d01d500b3b98a14b0181b93fdd6fdb68cb5be6c9`
...
3. keeps the current 3.1.1 tree and historical 1.20.1 tree physically distinct;
4. places historical source under an `.upstream`/reference-only location and never overlays it wholesale onto generated current source;
5. records deterministic provenance for every materialized authority;
6. fails if any immutable pin changes unexpectedly;
7. excludes Git metadata, caches, build outputs, generated runtime worlds/logs, and mutable download metadata from deterministic source packages.
