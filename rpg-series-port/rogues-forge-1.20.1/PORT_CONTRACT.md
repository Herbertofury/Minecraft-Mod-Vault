...
- integrated real-player tests for behavior that cannot honestly be proven with synthetic entities;
- GitHub evidence plus Google Drive persistence/round-trip verification before `GRADUATED`.

## Promotion rule

This prep branch starts from Paladins canonical `ba0ec5881b582953d69a93360fa5488a976da0a8`. While Paladins run #202 is authoritative, Rogues work stays isolated. After Paladins graduation, compare against the final graduated head and transplant/fast-forward only the Rogues-owned coherent delta; never force over newer canonical evidence.
