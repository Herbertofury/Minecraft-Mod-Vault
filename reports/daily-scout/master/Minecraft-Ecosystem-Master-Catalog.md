...
**Tracked serious projects/finds in canonical Google Sheet:** 81
...
## Latest material delta — 2026-08-24 late cycle

- **#4 / #28 performance — NEW SPECIALIST RUNNER-UP:** Just Enough Threads [JEI Startup Optimize]. Client-only Java mod with direct Forge 1.20.1 and NeoForge 1.21.1 paths. For Forge 1.20.1, verify Forge 47.4.4+ and JEI 15.20.0.120+. It moves JEI ingredient-search index work off-thread after world entry; 0.10.1 hardens FTB Quests/Ixeris startup interactions and prevents half-initialized recipe GUI access. Save-neutral and highly removable, but test with exact JEI integrations. https://www.curseforge.com/minecraft/mc-mods/just-enough-threads
- **#5 / #23 infrastructure — FRESH RUNNER-UP:** Fusion (Connected Textures) 1.3.14. A direct Forge 1.20.1 build exists, with broad modern loader/version coverage. 1.3.14 fixes item-model-generator registration; the surrounding maintenance line fixes model/culling/random-subtexture issues and substantially reduced Fusion model memory. It adds no gameplay world content itself, but dependent packs/mods can require it. https://www.curseforge.com/minecraft/mc-mods/fusion-connected-textures
- **#32 modern CIT ecosystem — NEW UTILITY WATCH:** Cozy CIT: Furniture Comes Alive. Java 1.21.1 Fabric/NeoForge. This is not a CIT resource pack or CIT renderer: it dynamically registers supported CIT furniture models as functional real blocks. Mizuno's 16 Craft alone yields 820+ furniture blocks; all supported packs can reach roughly 1,950+. Multiplayer pack sets should match; placed furniture is persistent world content, so removal is low-confidence and upgrade friendliness is caution. https://www.curseforge.com/minecraft/mc-mods/cozy-cit-furniture-comes-alive
- **Bedrock / Marketplace / PMC / #31 Animated / #33 3D — NO LATE-CYCLE LEADER CHANGE.** The sweep did not produce a defensible stronger replacement; current leaders stay put.
...
- **#31 Animated / #32 CIT / #33 3D:** visual leaders retained. Fresh Animations 1.10.4 remains the 1.20.x Java path; 1.10.5 is for 26.1.x/26.2. 3D Default 1.15.0 keeps an exact mc1.20–1.21.1 file. Better 3D Blocks still carries the maintainer's Distant Horizons LOD/FPS warning; its teased 2026-09-01 update is not treated as released.
...
- Links: https://modrinth.com/resourcepack/kaydicraft-cit • https://www.planetminecraft.com/texture-pack/the-faye-wallpaper-amp-flooring-cit-pack/ • https://www.curseforge.com/minecraft/mc-mods/cozy-cit-furniture-comes-alive
...
4. Best Performance/Optimization Mod — Legendary Block Entities 0.11.0 for Forge 1.20.1; **Just Enough Threads specialist runner-up**; Sodium modern line
5. Best Compatibility/Fix Mod — Collections Of Optimizations 2.4; **Fusion 1.3.14 fresh infrastructure runner-up**; Retromod experimental migration track
...
16. Best Bedrock Add-On — Canopy 1.6.1; Sweet Dreams watch
...
23. Best Modding/Development Tool or Library — Easy Model Entities 2.3.0; **Fusion 1.3.14 fresh infrastructure runner-up**
...
26. Best Client-Side-Only Mod — TargetsIndicate 1.2.0; **Just Enough Threads specialist candidate**; Outline N' Stuff future runner-up
...
**Optional JEI-heavy specialist:** Just Enough Threads may be layered in once its exact Forge/JEI minimums are satisfied. It is client-only and save-neutral, but because it changes JEI startup/index lifecycle, test it against JEI integrations before promoting it into a universal baseline.
